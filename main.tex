...
% This is a quantity very rarely observed, and needs estimating.
...
\begin{figure}
  ...
  \todo[inline]{Chop numbers from (A) x-axis and compress vertically}
...
We focus on the period between 10 Oct 2020 and 6 Dec 2020 inclusive, denoted as $1, \dots, T$, over which the CIS estimated stable infection prevalence~\citep{onsCISdec2020}.
...
We denote by $\sched_i$ the set of times individual $i = 1, \dots, \Ncis$ is tested, starting from their last test prior to time 1, if it exists, or their first test following enrolment in the study otherwise, and including all subsequent tests even those that occur after day $T$.
