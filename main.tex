...
This can be viewed as an approximation of Markov melding~\citep{goudieJoining}.
...
The discrete Beta process prior generalises the form of prior used in \cref{perf-test:sec:independent-priors} by allowing the central estimate of the hazard to vary over time~\citep{ibrahimBayesian,sunStatisticala}.
It is:
\begin{align}
