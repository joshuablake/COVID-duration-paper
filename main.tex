...
\section{Survival analysis framework}
...
For a small number\todo{how many?} of episodes, the individual is lost to follow-up before they test negative; these episodes are excluded from the analysis.
...
\section{Parameterising the survival function}
...
Instead, we propose a weakly informative (or vague) prior Beta(0.1, 1.9), which has mean 0.05 and minimal information.
...
\citet{birrellRTM2} estimated the total number of infections in England over the time period I consider, with posterior mean \numprint{4136368} and standard deviation \numprint{27932}.
