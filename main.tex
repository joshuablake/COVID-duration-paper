...
Incidence of infection can be estimated through convolution approaches {\it e.g.} ~\citep{brookmeyerBackcalculation},  which relate observations of a disease outcome with its incidence through a delay distribution.
In the context of SARS-CoV-2, this approach allows estimation of incidence based on: a time series of the proportion of the population that have a detectable infection; and the distribution of the duration of infection episodes, \ie the length of time an infection remains detectable using a particular test.
