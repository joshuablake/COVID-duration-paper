...
Code to reproduce figures and the simulation are available at \url{https://github.com/joshuablake/COVID-duration-paper}.
The raw Coronavirus (COVID-19) Infection Survey data is stored on the Office for National Statistics Secure Research Service due to regulatory requirements.
The data is accessible to bona fide researchers by application to the Office for National Statistics, see \url{https://www.ons.gov.uk/aboutus/whatwedo/statistics/requestingstatistics/secureresearchservice}.
