...
\if1\blind
{
  \title{\bf \fulltitle}
  \author{%
    Joshua Blake, Paul Birrell, A.\ Sarah Walker, Koen Pouwels, Thomas House,\\Brian Tom, Theo Kyparios, Daniela De Angelis  
    % Author 1\thanks{
...
These CIS data are unique, and the study may serve as a template for population prevalence studies in future pandemics~\citep{hallettModule1}.
